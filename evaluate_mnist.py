...
import resnet
from linear_model import LinearNetwork
...
# SSL
# python evaluate_mnist.py --pretrained exp_mnist/resnet50.pth --exp_dir ./exp_mnist --lr_head 0.02 --data_dir /hdd/zengs_data/vision_data --checkpoint_filename checkpoint.pth --epochs 100 
# 
# supervised
# python evaluate_mnist.py --pretrained exp_mnist/resnet50.pth --exp_dir ./exp_mnist --lr_head 0.02 --data_dir /hdd/zengs_data/vision_data --checkpoint_filename checkpoint.supervised.pth --epochs 100  --supvised
def main_worker(gpu, args):
  ...
  backbone, embedding = resnet.__dict__[args.arch](num_channels=1,
  ...
  if (args.exp_dir / args.checkpoint_filename).is_file():
    ckpt = torch.load(args.exp_dir / args.checkpoint_filename, map_location="cpu")
  ...
  train_dataset = datasets.MNIST(
      ...
      transform=transforms.Compose([
          transforms.RandomResizedCrop(21),
  ...
  for epoch in range(start_epoch, args.epochs):
    ...
    if args.rank == 0:
      ...
      torch.save(state, args.exp_dir / args.checkpoint_filename)
