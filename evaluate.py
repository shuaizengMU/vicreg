...
# python evaluate.py --data-dir /hdd/zengs_data/vision_data/imagenetmini-1000/new_dataset --pretrained exp/resnet50.pth --exp-dir ./exp --lr-head 0.02 --epochs 20
# python evaluate.py --data-dir /hdd/zengs_data/vision_data/imagenetmini-1000/new_dataset --pretrained exp/resnet50.pth --exp-dir ./exp --lr-head 0.02 --supvised --epochs 20
def main_worker(gpu, args):
  ...
  crop_size = 50
  if args.supvised:
    head = LinearNetwork(input_dim=3*crop_size*crop_size, output_dim=100)
      ...
      with torch.no_grad():
        for images, target in val_loader:
          ...
          acc1, acc5 = accuracy(output,
                                target.cuda(gpu, non_blocking=True),
                                topk=(1, 5))
